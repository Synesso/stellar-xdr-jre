...
public class TrustLineEntryExtensionV2 implements XdrElement {
  ...
  public static TrustLineEntryExtensionV2 decode(ByteString bs) throws IOException {
  ...
  public static class TrustLineEntryExtensionV2Ext {
    ...
    public static TrustLineEntryExtensionV2Ext decode(ByteString bs) throws IOException {
      return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
    }
