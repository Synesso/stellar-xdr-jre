...
public class LedgerHeaderExtensionV1 implements XdrElement {
  ...
  public static LedgerHeaderExtensionV1 decode(ByteString bs) throws IOException {
  ...
  public static class LedgerHeaderExtensionV1Ext {
    ...
    public static LedgerHeaderExtensionV1Ext decode(ByteString bs) throws IOException {
      return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
    }
