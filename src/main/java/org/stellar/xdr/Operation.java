...
public class Operation implements XdrElement {
  ...
  public static class OperationBody {
    ...
    @Override
    public int hashCode() {
      return Objects.hashCode(this.createAccountOp, this.paymentOp, this.pathPaymentStrictReceiveOp,
          this.manageSellOfferOp, this.createPassiveSellOfferOp, this.setOptionsOp, this.changeTrustOp,
          this.allowTrustOp, this.destination, this.manageDataOp, this.bumpSequenceOp, this.manageBuyOfferOp,
          this.pathPaymentStrictSendOp, this.createClaimableBalanceOp, this.claimClaimableBalanceOp,
          this.beginSponsoringFutureReservesOp, this.revokeSponsorshipOp, this.type);
    }
    ...
    public boolean equals(Object object) {
      ...
      return Objects.equal(this.createAccountOp, other.createAccountOp)
          ...
          && Objects.equal(this.beginSponsoringFutureReservesOp, other.beginSponsoringFutureReservesOp)
