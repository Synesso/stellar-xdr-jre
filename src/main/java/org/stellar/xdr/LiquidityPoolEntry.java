...
public class LiquidityPoolEntry implements XdrElement {
  ...
  public static LiquidityPoolEntry decode(ByteString bs) throws IOException {
  ...
  public static class LiquidityPoolEntryBody {
    ...
    public static LiquidityPoolEntryBody decode(ByteString bs) throws IOException {
      return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
    }
    ...
    public static class LiquidityPoolEntryConstantProduct {
      ...
      public static LiquidityPoolEntryConstantProduct decode(ByteString bs) throws IOException {
        return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
      }
