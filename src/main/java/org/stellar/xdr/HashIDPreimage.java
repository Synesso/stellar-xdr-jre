...
public class HashIDPreimage implements XdrElement {
  ...
  public static HashIDPreimage decode(ByteString bs) throws IOException {
  ...
  public static class HashIDPreimageOperationID {
    ...
    public static HashIDPreimageOperationID decode(ByteString bs) throws IOException {
      return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
    }
  ...
  public static class HashIDPreimageRevokeID {
    ...
    public static HashIDPreimageRevokeID decode(ByteString bs) throws IOException {
      return decode(new XdrDataInputStream(new ByteArrayInputStream(bs.toByteArray())));
    }
